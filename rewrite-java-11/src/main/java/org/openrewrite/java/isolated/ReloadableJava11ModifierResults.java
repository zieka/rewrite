...
public final class ReloadableJava11ModifierResults {

    private final /*~~>*/List<J.Annotation> leadingAnnotations;
    private final /*~~>*/List<J.Modifier> modifiers;

    public ReloadableJava11ModifierResults(/*~~>*/List<J.Annotation> leadingAnnotations, /*~~>*/List<J.Modifier> modifiers) {
